...
/*   Updated: 2021/12/10 22:28:42 by dkim2            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	gnl_cutstr(char *origine, char **front, char **rear, char c)
{
	char	*temp;
...
char	*get_next_line(int fd)
{
	...
	next_line[fd] = gnl_strappend(next_line[fd], temp);
	free(temp);
	if (gnl_cutstr(next_line[fd], &curr_line, &next_line[fd], '\n'))
		return (curr_line);
